...
— Представлен классом `EventEmitter`, который отслеживает изменения состояния приложения (события), вносит изменения в данные Модели и оповещает о них необходимые компоненты приложения, которые меняются в соответствии с произошедшим событием.
